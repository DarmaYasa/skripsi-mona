...
$check = mysqli_query($koneksi, "SELECT * FROM berkas_pensiun WHERE id_pensiun=$id");
...
if ($hasData) {
    $query = "UPDATE berkas_pensiun SET berkas_sk_pns='$berkas_sk_pns', berkas_kenaikan_pangkat='$berkas_kenaikan_pangkat', kartu_pegawai='$kartu_pegawai', berkas_karsi_karsu='$berkas_karsi_karsu', kartu_keluarga='$kartu_keluarga', surat_ket_alamat_pensiun='$alamat_pensiun' WHERE id_pensiun='$id'";
    echo $query;
} else {
    $query = "INSERT INTO berkas_pensiun (id_pensiun, berkas_sk_pns, berkas_kenaikan_pangkat, kartu_pegawai, berkas_karsi_karsu, kartu_keluarga, surat_ket_alamat_pensiun, terverifikasi) VALUES ('$id', '$berkas_sk_pns', '$berkas_kenaikan_pangkat', '$kartu_pegawai', '$berkas_karsi_karsu', '$kartu_keluarga', '$alamat_pensiun', '0')";
}
